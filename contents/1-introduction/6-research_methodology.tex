This thesis is built from a few \glspl{IN}, provided by Hopsworks \gls{AB}, and a few \glspl{PA} validated through a literature study. \\ Hopsworks's \glspl{IN} are:
\begin{itemize}

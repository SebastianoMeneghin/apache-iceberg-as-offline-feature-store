...
\medspace
In Table \ref{tbl:lakehouse_comparison}, in Appendix \ref{appx:tech_comp}, is presented a comparation between key features of the three data lakehouse frameworks.
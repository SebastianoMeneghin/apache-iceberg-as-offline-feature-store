...
The three main \gls{DBMS} technologies of this project are Hudi \cite{rajaperumalUberEngineeringIncremental2017}, Iceberg \cite{IcebergExamples2024} and Delta Lake \cite{armbrustDeltaLakeHighperformance2020}. These components are called \glspl{OTF} and they are the pivotal technology behind data lakehouses, serving as \glspl{DBMS} of those architectures. They provide an abstraction layer on top of data lakes, enabling database-like functionalities, enhancing data management capabilities significantly \cite{lakehouse2021,DataLakehouseSurvey2025}.
...
Despite these three \glspl{OTP} became the de-facto choice for data lakehouse implementation \cite{jainAnalyzingComparingLakehouse2023}, it must be noticed that new alternatives are being developed, such Apache Paimon~\footnote{GitHub repository available at \url{https://github.com/apache/paimon/}.}. However those technologies are still at early stages of their development and will not investigated in this thesis project.

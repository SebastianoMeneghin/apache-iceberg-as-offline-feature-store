...
\begin{table}[h]
    ...
    \hline
    \textit{Time Travel} & via snapshots & via transaction log & via incremental commits \\
    \hline
    ...
    \textit{File Formats} & 
        ...
        \end{tabular} & Parquet \\
    \hline
    \textit{Catalogs} & \begin{tabular}[t]{@{}l@{}} Hive \\ \gls{AWS} Glue \end{tabular} & \begin{tabular}[t]{@{}l@{}} Hive \\ \gls{AWS} Glue \\ Snowflake \\ JDBC \\ Nessie \\ REST \end{tabular} & \begin{tabular}[t]{@{}l@{}} Hive \\ \gls{AWS} Glue \\ Unity \end{tabular} \\
    \hline
    \textit{Query Engines} & 
        \begin{tabular}[t]{@{}l@{}} Spark \\ Flink \\ Hive \\ Impala \\ Presto 
        \end{tabular} & 
        \begin{tabular}[t]{@{}l@{}} Spark \\ Trino \\ Presto \\ Dremio \\ Flink \\ Athena \\ Snowflake 
        \end{tabular} & 
        \begin{tabular}[t]{@{}l@{}} Spark \\ Presto \\ Athena \\ Redshift \\ Snowflake 
        \end{tabular} \\
    \hline
    \textit{\glspl{API}} & 
        \begin{tabular}[t]{@{}l@{}} Java (Spark) \\ Scala (Spark,Flink) \\ Python (Spark) \\ Rust 
        \end{tabular} & 
        \begin{tabular}[t]{@{}l@{}} Java (Spark) \\ Python \\ Rust 
        \end{tabular} & 
        \begin{tabular}[t]{@{}l@{}} Scala (Spark) \\ Java (Spark,Flink) \\ Python (Spark) \\ Rust 
        \end{tabular} \\
    \hline
    \end{tabular}
    \end{table}
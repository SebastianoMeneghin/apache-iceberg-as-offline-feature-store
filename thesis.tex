...
\supervisorCsLastname{Bzhalava}
\supervisorCsFirstname{Davit}
\supervisorCsEmail{davit@hopsworks.ai}
...
%%                        TITLE OF TITLE PAGE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{IcedHops: reducing read and write latency in an Iceberg-backed offline feature store}
\subtitle{Integrating HopsFS and PyIceberg Python library to reduce read and write latency on Hopsworks offline feature store, with a comparative analysis of alternative solutions}

%% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{IcedHops: minska läs- och skrivlatens i en Iceberg-stödd offlinebutik för funktioner}
\altsubtitle{Integrering av HopsFS och PyIceberg Python-bibliotek för att minska läs- och skrivfördröjningen i den offline-lagringen Hopsworks, med en jämförande analys av alternativa lösningar.}
...
\EnglishKeywords{Machine Learning, Feature Store, Spark, Apache Iceberg, Delta Lake, Python, Read/Write Latency, Open Table Formats}
\SwedishKeywords{Maskininlärning, Feature Store, Spark, Apache Iceberg, Delta Lake, Python, Läs- och skrivlatens, Open Table Formats}

%%%%% For the oral presentation
%% Add this information once your examiner has scheduled your oral presentation
\presentationDateAndTimeISO{2025-02-25 15:00}
...
\opponentsNames{Arvid Wennerström}
...
\input{lib/pdf_related_includes.tex}
...
\chapter{Background and Related work}
    ...
    \input{contents/2-background_and_related_work/_all}

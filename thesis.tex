...
%%                        TITLE OF TITLE PAGE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Reducing read and write latency in an Iceberg-backed offline feature store}
\subtitle{Integrating HopsFS and PyIceberg Python library to reduce read and write latency on the Iceberg-backed Hopsworks offline feature store, with a comparative analysis of alternative solutions}

%% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{Minska läs- och skrivlatens i en Iceberg-stödd offlinebutik för funktioner}
\altsubtitle{Integrering av HopsFS och PyIceberg Python-bibliotek för att minska läs- och skrivfördröjningen i den Iceberg-stödda offline-lagringen Hopsworks, med en jämförande analys av alternativa lösningar.}
...
\EnglishKeywords{Machine Learning, Feature Store, Spark, Apache Iceberg, Python, Read/Write Latency, Open Table Formats}
\SwedishKeywords{Maskininlärning, Feature Store, Spark, Apache Iceberg, Python, Läs- och skrivlatens, Open Table Formats}
